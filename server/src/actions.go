...
func getRedisClient(data map[string]interface{}, getSelectedIndexClient bool, getKey bool) (redis.Conn, string) {
  var config connection
  id := getFromInterfaceOrFloat64ToInt(data["id"])
  config.ID = int64(id)
  var pool *redis.Pool
