<template>
    <div class="vue-terminal-wrapper">
        ...
        <div v-bind:style="{ maxHeight: this.height }" id="terminal" class="boring"
            v-bind:class="{ 'default-height': !fullScreen, 'fullscreen-height': fullScreen }" data-theme="boring"></div>
    </div>
</template>
...
import $ from 'jquery'
import Api from '../../RedisManager/api'
