                ...
                <Layout>
                    <Content
                        ...
                        <div v-if="currentConnectionId && currentDbIndex > -1 && typeof tabs[getTabsKey()] !== 'undefined' && !isEmptyObj(tabs[getTabsKey()]['keys'])"
                            :style="{ height: '100%' }">
                            <Tabs @on-tab-remove="handleTabRemove" :type="!isQtWebView() ? 'card' : 'line'"
                                :value="currentKey" :animated="false"
                        ...
                        <div v-if="currentConnectionId !== '' && pubsubModal"
                            ...
                            <ul class="infinite-list" style="position:relative; top: 30px;">
                                <li class="infinite-list-item" :key="index"
                                    v-for="(item, index) in chanMegs[getPubSubTabKey()]">
                                    {{ item }}
                                </li>
                            </ul>
                            ...
                            <div style="position:absolute; top:8px; left:20px; width:100%">
                                <Row>
                                    <Col span="6">
                                    <Input :name="currentConnection + 'addinput'" v-model="customChannel"
                                        placeholder="如果填写则选项失效">
                                    <span slot="prepend">自定义频道</span>
                                    </Input>
                                    </Col>
                                    <Col span="10" offset="1">
                                    <Input :name="currentConnection + 'input'" @keyup.enter.native="sendToChannel"
                                        v-model="channelMsg" placeholder="发布内容到订阅的频道">
